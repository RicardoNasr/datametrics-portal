// BUILD-MARKER: 2026-05-21-v6-RENAMED — fresh function, forces new build
// /api/shopify/token-exchange-v2.js  (renamed from token-exchange.js to bypass Vercel build cache)
...
export default async function handler(req, res) {
  console.log('>>> token-exchange-v2 BUILD v6 invoked, method=', req.method);
  setCors(res);
